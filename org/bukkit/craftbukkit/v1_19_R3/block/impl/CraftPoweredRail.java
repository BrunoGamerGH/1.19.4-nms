...
public final class CraftPoweredRail extends CraftBlockData implements RedstoneRail, Powerable, Rail, Waterlogged {
   private static final BlockStateBoolean POWERED = getBoolean(BlockPoweredRail.class, "powered");
   private static final BlockStateEnum<?> SHAPE = getEnum(BlockPoweredRail.class, "shape");
   private static final BlockStateBoolean WATERLOGGED = getBoolean(BlockPoweredRail.class, "waterlogged");
