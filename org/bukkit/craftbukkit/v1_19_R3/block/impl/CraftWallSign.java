...
public final class CraftWallSign extends CraftBlockData implements WallSign, Directional, Waterlogged {
   private static final BlockStateEnum<?> FACING = getEnum(BlockWallSign.class, "facing");
   private static final BlockStateBoolean WATERLOGGED = getBoolean(BlockWallSign.class, "waterlogged");
