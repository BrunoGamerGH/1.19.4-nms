...
public final class CraftLever extends CraftBlockData implements Switch, Directional, FaceAttachable, Powerable {
   private static final BlockStateEnum<?> FACE = getEnum(BlockLever.class, "face");
   private static final BlockStateEnum<?> FACING = getEnum(BlockLever.class, "facing");
   private static final BlockStateEnum<?> ATTACH_FACE = getEnum(BlockLever.class, "face");
   private static final BlockStateBoolean POWERED = getBoolean(BlockLever.class, "powered");
