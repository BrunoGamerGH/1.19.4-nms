...
public final class CraftBlockStates {
   private static final Map<Material, CraftBlockStates.BlockStateFactory<?>> FACTORIES = new HashMap<>();
   private static final CraftBlockStates.BlockStateFactory<?> DEFAULT_FACTORY = new CraftBlockStates.BlockStateFactory<CraftBlockState>(CraftBlockState.class) {
      @Override
      public CraftBlockState createBlockState(World world, BlockPosition blockPosition, IBlockData blockData, TileEntity tileEntity) {
         if (tileEntity != null) {
            ...
            Preconditions.checkState(tileEntity == null, "Unexpected BlockState for %s", CraftMagicNumbers.getMaterial(blockData.b()));
   ...
   static {
      ...
      register(
         ...
         CraftHangingSign.class,
         CraftHangingSign::new,
      ...
      register(
         Arrays.asList(Material.COMMAND_BLOCK, Material.REPEATING_COMMAND_BLOCK, Material.CHAIN_COMMAND_BLOCK),
         CraftCommandBlock.class,
         CraftCommandBlock::new,
         TileEntityCommand::new
      );
      register(
         Arrays.asList(
      ...
      register(Arrays.asList(Material.BEEHIVE, Material.BEE_NEST), CraftBeehive.class, CraftBeehive::new, TileEntityBeehive::new);
      register(Arrays.asList(Material.CAMPFIRE, Material.SOUL_CAMPFIRE), CraftCampfire.class, CraftCampfire::new, TileEntityCampfire::new);
   ...
   private static <T extends TileEntity, B extends CraftBlockEntityState<T>> void register(
      ...
      register(Collections.singletonList((T)blockType), blockStateType, blockStateConstructor, tileEntityConstructor);
   }
   ...
   private static <T extends TileEntity, B extends CraftBlockEntityState<T>> void register(
      ...
      CraftBlockStates.BlockStateFactory<B> factory = new CraftBlockStates.BlockEntityStateFactory<>(
         blockStateType, blockStateConstructor, tileEntityConstructor
      );
   ...
   public static TileEntity createNewTileEntity(Material material) {
      ...
      return factory instanceof CraftBlockStates.BlockEntityStateFactory
         ? ((CraftBlockStates.BlockEntityStateFactory)factory).createTileEntity(BlockPosition.b, CraftMagicNumbers.getBlock(material).o())
         : null;
   }
   ...
   public static BlockState getBlockState(Material material, @Nullable NBTTagCompound blockEntityTag) {
      return getBlockState(BlockPosition.b, material, blockEntityTag);
   }
   ...
   public static BlockState getBlockState(BlockPosition blockPosition, Material material, @Nullable NBTTagCompound blockEntityTag) {
      Preconditions.checkNotNull(material, "material is null");
      IBlockData blockData = CraftMagicNumbers.getBlock(material).o();
   ...
   public static BlockState getBlockState(IBlockData blockData, @Nullable NBTTagCompound blockEntityTag) {
      return getBlockState(BlockPosition.b, blockData, blockEntityTag);
   }
   ...
   private static class BlockEntityStateFactory<T extends TileEntity, B extends CraftBlockEntityState<T>> extends CraftBlockStates.BlockStateFactory<B> {
      ...
      protected BlockEntityStateFactory(
         Class<B> blockStateType, BiFunction<World, T, B> blockStateConstructor, BiFunction<BlockPosition, IBlockData, T> tileEntityConstructor
      ) {
      ...
      public final B createBlockState(World world, BlockPosition blockPosition, IBlockData blockData, TileEntity tileEntity) {
         if (world != null) {
            Preconditions.checkState(
               tileEntity != null, "Tile is null, asynchronous access? %s", CraftBlock.at(((CraftWorld)world).getHandle(), blockPosition)
            );
      ...
      private B createBlockState(World world, T tileEntity) {
         return this.blockStateConstructor.apply((T)world, tileEntity);
      }
   }
