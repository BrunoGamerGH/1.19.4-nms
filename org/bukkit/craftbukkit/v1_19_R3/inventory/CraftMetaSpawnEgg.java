...
public class CraftMetaSpawnEgg extends CraftMetaItem implements SpawnEggMeta {
   ...
   CraftMetaSpawnEgg(Map<String, Object> map) {
      super(map);
      String entityType = CraftMetaItem.SerializableMeta.getString(map, ENTITY_ID.BUKKIT, true);
      if (entityType != null) {
   ...
   void deserializeInternal(NBTTagCompound tag, Object context) {
      ...
      if (tag.e(ENTITY_TAG.NBT)) {
         ...
         if (this.spawnedType != null) {
            this.entityTag.r(ENTITY_ID.NBT);
         }

         this.entityTag.g();
         if (this.entityTag.e(ENTITY_ID.NBT)) {
            this.spawnedType = EntityType.fromName(new MinecraftKey(this.entityTag.l(ENTITY_ID.NBT)).a());
         }
      }
   }
   ...
   boolean equalsCommon(CraftMetaItem meta) {
      if (!super.equalsCommon(meta)) {
         ...
         return this.hasSpawnedType()
            ? that.hasSpawnedType() && this.spawnedType.equals(that.spawnedType)
            : (!that.hasSpawnedType() && this.entityTag != null ? that.entityTag != null && this.entityTag.equals(that.entityTag) : this.entityTag == null);
      }
   }
