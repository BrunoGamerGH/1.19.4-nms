...
final class CraftScoreboardTranslations {
   ...
   static final ImmutableBiMap<DisplaySlot, String> SLOTS = ImmutableBiMap.builder()
   ...
   static DisplaySlot toBukkitSlot(int i) {
      return (DisplaySlot)SLOTS.inverse().get(Scoreboard.b(i));
   }

   static int fromBukkitSlot(DisplaySlot slot) {
      return Scoreboard.j((String)SLOTS.get(slot));
   }
