...
public final class CraftCeilingHangingSign extends CraftBlockData implements HangingSign, Attachable, Rotatable, Waterlogged {
   private static final BlockStateBoolean ATTACHED = getBoolean(CeilingHangingSignBlock.class, "attached");
   private static final BlockStateInteger ROTATION = getInteger(CeilingHangingSignBlock.class, "rotation");
   private static final BlockStateBoolean WATERLOGGED = getBoolean(CeilingHangingSignBlock.class, "waterlogged");

   public CraftCeilingHangingSign() {
   }

   public CraftCeilingHangingSign(IBlockData state) {
      super(state);
   }
