...
public final class CraftFloorSign extends CraftBlockData implements Sign, Rotatable, Waterlogged {
   private static final BlockStateInteger ROTATION = getInteger(BlockFloorSign.class, "rotation");
   private static final BlockStateBoolean WATERLOGGED = getBoolean(BlockFloorSign.class, "waterlogged");

   public CraftFloorSign() {
   }

   public CraftFloorSign(IBlockData state) {
      super(state);
   }
