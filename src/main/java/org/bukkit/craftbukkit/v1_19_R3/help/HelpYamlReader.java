...
public class HelpYamlReader {
   ...
   public HelpYamlReader(Server server) {
      ...
      YamlConfiguration defaultConfig = YamlConfiguration.loadConfiguration(
         new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("configurations/help.yml"), Charsets.UTF_8)
      );
      ...
      try {
         ...
         try {
            ...
            server.getLogger().log(Level.SEVERE, "Could not save " + helpYamlFile, (Throwable)var5);
         }
