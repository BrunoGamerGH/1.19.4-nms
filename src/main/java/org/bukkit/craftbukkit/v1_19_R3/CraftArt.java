...
public class CraftArt {
   ...
   static {
      Builder<Holder<PaintingVariant>, Art> artworkBuilder = ImmutableBiMap.builder();

      for(ResourceKey<PaintingVariant> key : BuiltInRegistries.m.f()) {
         artworkBuilder.put(BuiltInRegistries.m.f(key), Art.getByName(key.a().a()));
      }
   ...
   public static Holder<PaintingVariant> BukkitToNotch(Art art) {
      Holder<PaintingVariant> nms = (Holder)artwork.inverse().get(art);
