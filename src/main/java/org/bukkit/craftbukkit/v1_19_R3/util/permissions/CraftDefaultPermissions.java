...
public final class CraftDefaultPermissions {
   ...
   public static void registerCorePermissions() {
      ...
      DefaultPermissions.registerPermission(
         "minecraft.nbt.place", "Gives the user the ability to place restricted blocks with NBT in creative", PermissionDefault.OP, parent
      );
      ...
      DefaultPermissions.registerPermission(
         "minecraft.debugstick", "Gives the user the ability to use the debug stick in creative", PermissionDefault.OP, parent
      );
      DefaultPermissions.registerPermission(
         "minecraft.debugstick.always", "Gives the user the ability to use the debug stick in all game modes", PermissionDefault.FALSE, parent
      );
