...
public class LootTables {
   private static final Set<MinecraftKey> aB = Sets.newHashSet();
   private static final Set<MinecraftKey> aC = Collections.unmodifiableSet(aB);
   ...
   public static final MinecraftKey P = a("chests/ancient_city");
   public static final MinecraftKey Q = a("chests/ancient_city_ice_box");
   public static final MinecraftKey R = a("chests/ruined_portal");
   public static final MinecraftKey S = a("entities/sheep/white");
   public static final MinecraftKey T = a("entities/sheep/orange");
   public static final MinecraftKey U = a("entities/sheep/magenta");
   public static final MinecraftKey V = a("entities/sheep/light_blue");
   public static final MinecraftKey W = a("entities/sheep/yellow");
   public static final MinecraftKey X = a("entities/sheep/lime");
   public static final MinecraftKey Y = a("entities/sheep/pink");
   public static final MinecraftKey Z = a("entities/sheep/gray");
   public static final MinecraftKey aa = a("entities/sheep/light_gray");
   public static final MinecraftKey ab = a("entities/sheep/cyan");
   public static final MinecraftKey ac = a("entities/sheep/purple");
   public static final MinecraftKey ad = a("entities/sheep/blue");
   public static final MinecraftKey ae = a("entities/sheep/brown");
   public static final MinecraftKey af = a("entities/sheep/green");
   public static final MinecraftKey ag = a("entities/sheep/red");
   public static final MinecraftKey ah = a("entities/sheep/black");
   public static final MinecraftKey ai = a("gameplay/fishing");
   public static final MinecraftKey aj = a("gameplay/fishing/junk");
   public static final MinecraftKey ak = a("gameplay/fishing/treasure");
   public static final MinecraftKey al = a("gameplay/fishing/fish");
   public static final MinecraftKey am = a("gameplay/cat_morning_gift");
   public static final MinecraftKey an = a("gameplay/hero_of_the_village/armorer_gift");
   public static final MinecraftKey ao = a("gameplay/hero_of_the_village/butcher_gift");
   public static final MinecraftKey ap = a("gameplay/hero_of_the_village/cartographer_gift");
   public static final MinecraftKey aq = a("gameplay/hero_of_the_village/cleric_gift");
   public static final MinecraftKey ar = a("gameplay/hero_of_the_village/farmer_gift");
   public static final MinecraftKey as = a("gameplay/hero_of_the_village/fisherman_gift");
   public static final MinecraftKey at = a("gameplay/hero_of_the_village/fletcher_gift");
   public static final MinecraftKey au = a("gameplay/hero_of_the_village/leatherworker_gift");
   public static final MinecraftKey av = a("gameplay/hero_of_the_village/librarian_gift");
   public static final MinecraftKey aw = a("gameplay/hero_of_the_village/mason_gift");
   public static final MinecraftKey ax = a("gameplay/hero_of_the_village/shepherd_gift");
   public static final MinecraftKey ay = a("gameplay/hero_of_the_village/toolsmith_gift");
   public static final MinecraftKey az = a("gameplay/hero_of_the_village/weaponsmith_gift");
   public static final MinecraftKey aA = a("gameplay/piglin_bartering");
