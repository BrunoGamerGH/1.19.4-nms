...
public class DataConverterPotionId extends DataFix {
   ...
   private static final String[] c = (String[])DataFixUtils.make(new String[128], var0 -> {
   ...
   public DataConverterPotionId(Schema var0, boolean var1) {
      super(var0, var1);
   }
      ...
      return this.fixTypeEverywhereTyped(
         ...
         var2x -> {
            ...
            if (var3x.isPresent() && Objects.equals(((Pair)var3x.get()).getSecond(), "minecraft:potion")) {
               ...
               Optional<? extends Typed<?>> var5 = var2x.getOptionalTyped(var2);
               short var6 = var4.get("Damage").asShort((short)0);
               if (var5.isPresent()) {
                  Typed<?> var7 = var2x;
                  Dynamic<?> var8 = (Dynamic)((Typed)var5.get()).get(DSL.remainderFinder());
                  Optional<String> var9 = var8.get("Potion").asString().result();
                  if (!var9.isPresent()) {
                     String var10 = c[var6 & 127];
                     Typed<?> var11 = ((Typed)var5.get())
                        .set(DSL.remainderFinder(), var8.set("Potion", var8.createString(var10 == null ? "minecraft:water" : var10)));
                     var7 = var2x.set(var2, var11);
                     if ((var6 & 16384) == 16384) {
                        var7 = var7.set(var1, Pair.of(DataConverterTypes.s.typeName(), "minecraft:splash_potion"));
                     }
                  }
