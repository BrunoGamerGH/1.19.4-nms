...
public class DataConverterFlattenData {
   ...
   private static final Object2IntMap<String> f = (Object2IntMap<String>)DataFixUtils.make(new Object2IntOpenHashMap(), var0 -> var0.defaultReturnValue(-1));
   ...
   public static Dynamic<?> a(Dynamic<?> var0) {
      int var1 = e.getInt(var0);
      if (var1 >= 0 && var1 < c.length) {
         Dynamic<?> var2 = c[var1];
   ...
   public static Dynamic<?> b(String var0) {
      try {
         return new Dynamic(DynamicOpsNBT.a, MojangsonParser.a(var0.replace('\'', '"')));
      } catch (Exception var2) {
         b.error("Parsing {}", var0, var2);
