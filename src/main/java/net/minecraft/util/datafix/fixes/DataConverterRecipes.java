...
public class DataConverterRecipes extends DataConverterRecipeBase {
   ...
   public DataConverterRecipes(Schema var0, boolean var1) {
      super(var0, var1, "Recipes fix", var0x -> a.getOrDefault(var0x, var0x));
   }
}
