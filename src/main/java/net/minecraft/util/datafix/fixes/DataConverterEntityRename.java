...
public class DataConverterEntityRename extends DataConverterEntityRenameAbstract {
   ...
   public DataConverterEntityRename(Schema var0, boolean var1) {
      super("EntityTheRenameningBlock", var0, var1);
   }

   @Override
   protected String a(String var0) {
      if (var0.startsWith("minecraft:bred_")) {
         var0 = "minecraft:" + var0.substring("minecraft:bred_".length());
      }
