...
public class DataConverterKeybind extends DataFix {
   ...
   private static final Int2ObjectMap<String> b = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
   ...
   public DataConverterKeybind(Schema var0, boolean var1) {
      super(var0, var1);
   }
               ...
               DSL.remainderFinder(), var0x -> (Dynamic)var0x.getMapValues().map(var1 -> var0x.createMap(var1.entrySet().stream().map(var0xxx -> {
                        if (((Dynamic)var0xxx.getKey()).asString("").startsWith("key_")) {
                           ...
                           if (var1x < 0) {
                              ...
                              String var2 = (String)b.getOrDefault(var1x, "key.unknown");
