...
public class V3081 extends DataConverterSchemaNamed {
   public V3081(int var0, Schema var1) {
      super(var0, var1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var0) {
      ...
      var0.register(
         ...
         "minecraft:warden",
         () -> DSL.optionalFields(
               "listener", DSL.optionalFields("event", DSL.optionalFields("game_event", DataConverterTypes.t.in(var0))), DataConverterSchemaV100.a(var0)
            )
      );
      return var1;
   }
