...
public class V2684 extends DataConverterSchemaNamed {
   public V2684(int var0, Schema var1) {
      super(var0, var1);
   }
   ...
   public void registerTypes(Schema var0, Map<String, Supplier<TypeTemplate>> var1, Map<String, Supplier<TypeTemplate>> var2) {
      ...
      var0.registerType(false, DataConverterTypes.t, () -> DSL.constType(a()));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var0) {
      ...
      var0.register(
         ...
         () -> DSL.optionalFields("listener", DSL.optionalFields("event", DSL.optionalFields("game_event", DataConverterTypes.t.in(var0))))
      );
      return var1;
   }
}
