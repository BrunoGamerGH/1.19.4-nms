...
public interface PacketListenerPlayIn extends ServerPacketListener {
   ...
   void a(ServerboundChatCommandPacket var1);

   void a(ServerboundChatAckPacket var1);
   ...
   void a(ServerboundPongPacket var1);
   ...
   void a(PacketPlayInRecipeSettings var1);
   ...
   void a(PacketPlayInSetJigsaw var1);

   void a(PacketPlayInJigsawGenerate var1);

   void a(PacketPlayInDifficultyChange var1);

   void a(PacketPlayInDifficultyLock var1);

   void a(ServerboundChatSessionUpdatePacket var1);
}
