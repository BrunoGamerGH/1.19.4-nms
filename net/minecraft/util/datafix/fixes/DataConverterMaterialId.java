...
public class DataConverterMaterialId extends DataFix {
   public static final Int2ObjectMap<String> a = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), var0 -> {
   ...
   public DataConverterMaterialId(Schema var0, boolean var1) {
      super(var0, var1);
   }
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> var0 = DSL.or(DSL.intType(), DSL.named(DataConverterTypes.s.typeName(), DataConverterSchemaNamed.a()));
      Type<Pair<String, String>> var1 = DSL.named(DataConverterTypes.s.typeName(), DataConverterSchemaNamed.a());
      OpticFinder<Either<Integer, Pair<String, String>>> var2 = DSL.fieldFinder("id", var0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(DataConverterTypes.m),
         this.getOutputSchema().getType(DataConverterTypes.m),
         var2x -> var2x.update(
               var2, var1, var0xx -> (Pair)var0xx.map(var0xxx -> Pair.of(DataConverterTypes.s.typeName(), a(var0xxx.intValue())), var0xxx -> var0xxx)
            )
      );
   }
}
