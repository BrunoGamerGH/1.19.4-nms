...
public class DataConverterAdvancement extends DataConverterAdvancementBase {
   ...
   public DataConverterAdvancement(Schema var0, boolean var1) {
      super(var0, var1, "AdvancementsFix", var0x -> a.getOrDefault(var0x, var0x));
   }
}
