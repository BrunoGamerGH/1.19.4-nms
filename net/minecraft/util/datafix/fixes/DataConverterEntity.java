...
public class DataConverterEntity extends DataFix {
   ...
   public DataConverterEntity(Schema var0, boolean var1) {
      super(var0, var1);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> var2 = this.getInputSchema().getType(DataConverterTypes.m);
      Type<?> var3 = this.getOutputSchema().getType(DataConverterTypes.m);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack entity name hook converter", var2, var3),
         this.fixTypeEverywhere("EntityIdFix", var0, var1, var0x -> var0xx -> var0xx.mapFirst(var0xxx -> a.getOrDefault(var0xxx, var0xxx)))
      );
   }
}
