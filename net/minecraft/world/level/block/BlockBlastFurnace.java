...
public class BlockBlastFurnace extends BlockFurnace {
   ...
   public void a(IBlockData var0, World var1, BlockPosition var2, RandomSource var3) {
      if (var0.c(b)) {
         ...
         if (var3.j() < 0.1) {
            var1.a(var4, var6, var8, SoundEffects.cf, SoundCategory.e, 1.0F, 1.0F, false);
         }
